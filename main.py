...
class Player(pygame.sprite.Sprite): 
    def __init__(self):
        super().__init__()
        #imports the sprites
        player_walk1 = pygame.image.load("images/mario/skg-run1.png").convert_alpha()
        player_walk2 = pygame.image.load("images/mario/skg-run2.png").convert_alpha()
        player_walk3 = pygame.image.load("images/mario/skg-run3.png").convert_alpha()
        self.player_walk = [player_walk1, player_walk2, player_walk3]
        self.player_index = 0
        self.player_jump = pygame.image.load("images/mario/skg-jump.png").convert_alpha()
...
pygame.display.set_caption("Depressed Artist")
...
#Intro Screen
player_stand = pygame.image.load("images/mario/skg-run1.png").convert_alpha()
...
name_surf = game_name.render("Depressed Artist :,)", False, "White")
